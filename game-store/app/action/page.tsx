    ...
    useEffect(() => {
        const fetchGames = async () => {
            try {
                ...
                setGames(
                    data.products.filter((user: any) => user.catagory === 'Action')
                );
                console.log(data.products.find((user: any) => user.catagory === 'Action'));
                if (!response.ok) {
    ...
    return (
        <div>
            <div className='bg-slate-100 py-10'>
                <div className='text-center text-3xl mb-10'>Action</div>
