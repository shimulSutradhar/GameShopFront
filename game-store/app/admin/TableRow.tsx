    ...
    return (
        <tr>
            ...
            <td className="border border-[#ccc] p-2">
                <TextData keyName="catagory" index={index} id={data._id.$oid} games={games} setGames={setGames} />
            </td>
            <td className="border border-[#ccc] p-2">
                <TextData keyName="key_features" index={index} id={data._id.$oid} games={games} setGames={setGames} />
            </td>
            <td className="border border-[#ccc]">
